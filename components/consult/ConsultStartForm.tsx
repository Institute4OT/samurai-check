    ...
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-8">
      ...
      <div className="mt-3 rounded-lg border px-4 py-2 text-xs text-muted-foreground space-y-2">
        {rid ? (
          ...
          <div>
            <Label htmlFor="rid-input" className="text-xs">
              結果ID（rid）が未検出です。結果ページのURLまたはIDを貼り付けてください。
            </Label>
            <Input
              id="rid-input"
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-8">
        ...
        <section>
          <h2 className="font-semibold mb-2">
            ご相談トピック{" "}
            <span className="text-red-600 text-xs">（必須・複数選択可）</span>
          </h2>

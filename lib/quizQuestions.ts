...
export const quizQuestions: QuizQuestion[] = [
  ...
  // Q8（単一選択）
  {
    ...
    options: [
      ...
      { text: '社員が自ら「会社や自分たちのビジョン」について語り、行動できる状態になっている', score: 3 },
    ],
    isMultipleChoice: false,
  ...
  // Q9
  {
    ...
    options: [
      ...
      { text: '社員同士が、性別や年齢、役職等の壁を越えて交流しているようだ', score: 3 },
  ...
  // Q15
  {
    ...
    options: [
      ...
      { text: '自分は、プライベートな話題は相手が自ら言及した場合のみ応じる形にしている', score: 1 },
      { text: '社内は、同意のないプライベート質問や属性コメントは避ける運用にしている', score: 2 },

...
export const answerRules: AnswerRule[] = [
  // ===== 権限委譲・自律 =====
  {
    ...
    emit: [
      { key: "delegate_pos", category: "talent", weight: 95,
  ...
  },
  {
    ...
    emit: [
      { key: "delegate_neg", category: "challenge", weight: 95,
  ...
  // ===== コミュニケーション・対話 =====
  {
    ...
    emit: [
      { key: "comms_pos", category: "talent", weight: 90,
  ...
  },
  {
    ...
    emit: [
      { key: "comms_neg", category: "challenge", weight: 90,
  ...
  // ===== 学習・検証 =====
  {
    ...
    emit: [
      { key: "learn_pos", category: "talent", weight: 85,
  ...
  },
  {
    ...
    emit: [
      { key: "learn_neg", category: "challenge", weight: 85,
  ...
  // ===== 顧客起点・アウトカム =====
  {
    ...
    emit: [
      { key: "customer_pos", category: "talent", weight: 80,
  ...
  },
  {
    ...
    emit: [
      { key: "customer_neg", category: "challenge", weight: 80,
  ...
  // ===== 可視化・計測 =====
  {
    ...
    emit: [
      { key: "measure_pos", category: "talent", weight: 75,
  ...
  },
  {
    ...
    emit: [
      { key: "measure_neg", category: "challenge", weight: 75,
  ...
  // ===== 連携・越境 =====
  {
    ...
    emit: [
      { key: "cross_pos", category: "talent", weight: 70,
  ...
  },
  {
    ...
    emit: [
      { key: "cross_neg", category: "challenge", weight: 70,
  ...
  // ===== 目的・方針 =====
  {
    ...
    emit: [
      { key: "purpose_pos", category: "talent", weight: 65,
  ...
  },
  {
    ...
    emit: [
      { key: "purpose_neg", category: "challenge", weight: 65,
